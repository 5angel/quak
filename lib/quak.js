...
/***/ function(module, exports) {
	...
	function isHandler(str) {
	  return RE_EVENTS.test(str);
	}

	function toEvent(str) {
	...
	var View = function () {
	  ...
	  _createClass(View, [{
	    ...
	    value: function mount(model) {
	      ...
	      this._bindings = (0, _parse2.default)(container);
	      ...
	      try {
	        for (var _iterator = this._bindings[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var _step$value = _step.value;
	          var node = _step$value.node;
	          var attr = _step$value.attr;
	          var expr = _step$value.expr;

	          if ((0, _utils.isTag)(attr)) {
	            // TODO: recognize views
	          } else if ((0, _utils.isHandler)(attr)) {
	            var handler = (0, _utils.resolve)(model, expr, this.update.bind(this));
	            var event = (0, _utils.toEvent)(attr);
	            var list = this._handlers[name] || [];

	            list.push({ node: node, handler: handler });
	    ...
	    value: function update() {
	      ...
	      try {
	        for (var _iterator3 = this._bindings[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	          ...
	          var attr = _step3$value.attr;
	          var tmpl = _step3$value.tmpl;
	          var value = _step3$value.value;
	          var expr = _step3$value.expr;

	          if ((0, _utils.isTag)(attr)) {
	            // TODO: recognize views
	          } else if (!(0, _utils.isUndefined)(tmpl)) {
	            node.nodeValue = tmpl.replace(value, (0, _utils.resolve)(model, expr));
	          }
	        }
	      } catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function parseExprs(str, base) {
	  ...
	  while (match = RE_EXPR.exec(str)) {
	    ...
	    list.push((0, _utils.extend)({}, base, { value: value, expr: expr }));
	  }
	  return list;
	}
	  ...
	  (0, _utils.walkDom)(container, function (node) {
	    ...
	    switch (node.nodeType) {
	      case ELEMENT:
	        ...
	        try {
	          for (var _iterator = (0, _utils.toArray)(node.attributes)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            tagFound = tagFound || (0, _utils.isTag)(attr);

	            if ((0, _utils.isTag)(attr) || (0, _utils.isHandler)(attr)) {
	              node.removeAttribute(attr);
	            }

	            result.push.apply(result, _toConsumableArray(parseExprs(value, { node: node, attr: attr })));
	          }
	        } catch (err) {
	          _didIteratorError = true;
	          _iteratorError = err;
	      ...
	      case TEXT:
	        ...
	        result.push.apply(result, _toConsumableArray(parseExprs(tmpl, { node: node, tmpl: tmpl })));
	        break;
	    }
