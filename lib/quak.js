	...
	var View = function () {
	  ...
	  _createClass(View, [{
	    ...
	    value: function mount(model) {
	      ...
	      try {
	        for (var _iterator2 = (0, _parse2.default)(container)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          var _step2$value = _step2.value;
	          var _node = _step2$value.node;
	          var handlers = _step2$value.handlers;
	          var bindings = _step2$value.bindings;
	
	          this._handlers.push((0, _utils.extend)(handlers.slice(), { node: _node }));
	          this._bindings.push((0, _utils.extend)(bindings.slice(), { node: _node }));
	        }
	      } catch (err) {
	        _didIteratorError2 = true;
	        _iteratorError2 = err;
