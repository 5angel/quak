...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parse3 = __webpack_require__(/*! parse */ 3);
	    ...
	    value: function render() {
	      ...
	      try {
	        ...
	        for (var _iterator = binds[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          ...
	          try {
	            for (var _iterator4 = _list2[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	      ...
	      for (var prop in attrs) {
	        if (attrs.hasOwnProperty(prop)) {
	          ...
	          try {
	            for (var _iterator2 = attrs[prop][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	              var _step2$value = _step2.value;
	              var node = _step2$value.node;
	              var expr = _step2$value.expr;
	              ...
	              if ((0, _utils.isView)(prop)) {
	                ...
	                var _list = this._handlers[event] || [];
