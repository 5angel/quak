	...
	var View = function () {
	  ...
	  _createClass(View, [{
	    ...
	    value: function mount(model) {
	      ...
	      var renderFn = this.render.bind(this);
	      ...
	      try {
	        var _loop = function _loop() {
	          ...
	          (_handlers = _this._handlers).push.apply(_handlers, _toConsumableArray(handlers.map(function (_ref) {
	            var expr = _ref.expr;
	            var attr = _ref.attr;
	
	            var event = (0, _utils.toEvent)(attr);
	            var callback = function callback(e) {
	              (0, _resolve2.default)(expr, renderFn)(_this.model, e);
	            };
	          ...
	          if (bindings.length) {
	            _this._bindings.push((0, _utils.extend)(bindings.slice(), { node: node }));
	          }
	        };
	    ...
	    value: function render() {
	      ...
	      try {
	        for (var _iterator3 = this._bindings[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	          ...
	          var _node2 = list.node;
	          var isTextNode = _node2.nodeType === 3;
	
	          if (isTextNode) {
	            _node2.nodeValue = list[0].tmpl;
	          }
	          ...
	          try {
	            for (var _iterator4 = list[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	              ...
	              if (isTextNode) {
	                _node2.nodeValue = _node2.nodeValue.replace(value, (0, _resolve2.default)(expr)(model));
	              }
	            }
	          } catch (err) {
	...
	function parse(container) {
	  ...
	  (0, _utils.walkDom)(container, function (node) {
	      ...
	      case 1:
	        ...
	        try {
	          for (var _iterator = (0, _utils.toArray)(node.attributes)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            var hasTag = (0, _utils.isTag)(attr);
	            var hasHandler = (0, _utils.isHandler)(attr);
	            ...
	            var items = parseExpressions(value, attr);
	
	            hasHandler ? handlers.push.apply(handlers, _toConsumableArray(items)) : bindings.push.apply(bindings, _toConsumableArray(items));
	          }
	        } catch (err) {
	          _didIteratorError = true;
	          _iteratorError = err;
	    ...
	    if (bindings.length + handlers.length > 0) {
	      result.push({ node: node, bindings: bindings, handlers: handlers });
	    }
