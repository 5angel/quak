	...
	var View = function () {
	  ...
	  _createClass(View, [{
	    ...
	    value: function mount(model) {
	      ...
	      var bindings = (0, _parse2.default)(container);
	      ...
	      try {
	        for (var _iterator = bindings[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          ...
	          for (var i = list.length - 1; i >= 0; --i) {
	            var _list$i = list[i];
	            var expr = _list$i.expr;
	            var attr = _list$i.attr;
	      ...
	      this._bindings = bindings.filter(function (item) {
	        return item.length;
	      });
	        ...
	        for (var _iterator3 = this._bindings[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	          ...
	          try {
	            for (var _iterator4 = list[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	              ...
	              var attr = _step4$value.attr;

	              if (isTextNode) {
	                node.nodeValue = node.nodeValue.replace(value, (0, _utils.resolve)(model, expr));
	              }
	            }
	          } catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function parse(container) {
	  ...
	  (0, _utils.walkDom)(container, function (node) {
	    var list = (0, _utils.extend)([], { node: node });
	    var tagFound = false;
	    ...
	    switch (node.nodeType) {
	      case 1:
	        ...
	        try {
	          for (var _iterator = (0, _utils.toArray)(node.attributes)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            list.push.apply(list, _toConsumableArray(parseExpressions(value, attr)));
	          }
	        } catch (err) {
	          _didIteratorError = true;
	          _iteratorError = err;
	      ...
	      case 3:
	        // text
	        list.push.apply(list, _toConsumableArray(parseExpressions(node.nodeValue)));
	        break;
	    }
